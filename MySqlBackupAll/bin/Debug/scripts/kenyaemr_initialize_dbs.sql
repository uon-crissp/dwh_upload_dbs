...
INSERT INTO etl_script_status(script_name, start_time) VALUES('KenyaEMR_Data_Tool', NOW());
SET script_id = LAST_INSERT_ID();

drop table if exists tools_alcohol_drug_abuse_screening;
drop table if exists tools_art_preparation;
drop table if exists tools_client_trace;
drop table if exists tools_current_in_care;
drop table if exists tools_default_facility_info;
drop table if exists tools_drug_event;
drop table if exists tools_enhanced_adherence;
drop table if exists tools_gender_based_violence;
drop table if exists tools_hei_enrollment;
drop table if exists tools_hei_follow_up_visit;
drop table if exists tools_hei_immunization;
drop table if exists tools_hiv_enrollment;
drop table if exists tools_hiv_followup;
drop table if exists tools_hts_referral;
drop table if exists tools_hts_referral_and_linkage;
drop table if exists tools_hts_test;
drop table if exists tools_ipt_followup;
drop table if exists tools_laboratory_extract;
drop table if exists tools_mch_antenatal_visit;
drop table if exists tools_mch_delivery;
drop table if exists tools_mch_discharge;
drop table if exists tools_mch_enrollment;
drop table if exists tools_mch_postnatal_visit;
drop table if exists tools_patient_contact;
drop table if exists tools_patient_demographics;
drop table if exists tools_patient_program_discontinuation;
drop table if exists tools_person_address;
drop table if exists tools_pharmacy_extract;
drop table if exists tools_tb_enrollment;
drop table if exists tools_tb_follow_up_visit;
drop table if exists tools_tb_screening;
drop table if exists tools_triage;

create table tools_patient_demographics as
select 
patient_id,
given_name,
middle_name,
...
death_date,
voided
from etl_patient_demographics;

ALTER TABLE tools_patient_demographics ADD PRIMARY KEY(patient_id);
ALTER TABLE tools_patient_demographics ADD INDEX(Gender);
SELECT "Successfully created demographics table";
create table tools_hiv_enrollment as
select 
patient_id,
uuid,
visit_id,
...
from etl_hiv_enrollment;


ALTER TABLE tools_hiv_enrollment ADD FOREIGN KEY (patient_id) REFERENCES tools_patient_demographics(patient_id);

ALTER TABLE tools_hiv_enrollment ADD INDEX(visit_date);
ALTER TABLE tools_hiv_enrollment ADD INDEX(arv_status);
ALTER TABLE tools_hiv_enrollment ADD INDEX(date_confirmed_hiv_positive);
ALTER TABLE tools_hiv_enrollment ADD INDEX(entry_point);

SELECT "Successfully created hiv enrollment table";
create table tools_hiv_followup as
select 
patient_id,
visit_id,
visit_date,
...
from etl_patient_hiv_followup;

ALTER TABLE tools_hiv_followup ADD FOREIGN KEY (patient_id) REFERENCES tools_patient_demographics(patient_id);

ALTER TABLE tools_hiv_followup ADD INDEX(visit_date);
ALTER TABLE tools_hiv_followup ADD INDEX(pregnancy_status);
ALTER TABLE tools_hiv_followup ADD INDEX(family_planning_status);
ALTER TABLE tools_hiv_followup ADD INDEX(tb_status);
ALTER TABLE tools_hiv_followup ADD INDEX(ctx_dispensed);
ALTER TABLE tools_hiv_followup ADD INDEX(population_type);
ALTER TABLE tools_hiv_followup ADD INDEX(on_anti_tb_drugs);
ALTER TABLE tools_hiv_followup ADD INDEX(stability);
ALTER TABLE tools_hiv_followup ADD INDEX(differentiated_care);

SELECT "Successfully created hiv followup table";
create table tools_laboratory_extract as
select 
uuid,
encounter_id,
patient_id,
...
ALTER TABLE tools_laboratory_extract ADD FOREIGN KEY (patient_id) REFERENCES tools_patient_demographics(patient_id);

ALTER TABLE tools_laboratory_extract ADD INDEX(visit_date);
ALTER TABLE tools_laboratory_extract ADD INDEX(lab_test);
ALTER TABLE tools_laboratory_extract ADD INDEX(test_result);

SELECT "Successfully created lab extract table";
create table tools_pharmacy_extract as
select 
patient_id,
uuid,
visit_date,
...
date_voided,
dispensing_provider
from etl_pharmacy_extract;

ALTER TABLE tools_pharmacy_extract ADD FOREIGN KEY (patient_id) REFERENCES tools_patient_demographics(patient_id);
create table tools_patient_program_discontinuation as
select 
patient_id,
uuid,
visit_id,
...
ALTER TABLE tools_patient_program_discontinuation ADD FOREIGN KEY (patient_id) REFERENCES tools_patient_demographics(patient_id);

ALTER TABLE tools_patient_program_discontinuation ADD INDEX(visit_date);
ALTER TABLE tools_patient_program_discontinuation ADD INDEX(discontinuation_reason);
SELECT "Successfully created pharmacy extract table";
  create table tools_mch_enrollment as
    select
      patient_id,
      uuid,
      visit_id,
    ...
    from etl_mch_enrollment;

  ALTER TABLE tools_mch_enrollment ADD FOREIGN KEY (patient_id) REFERENCES tools_patient_demographics(patient_id);
  ALTER TABLE tools_mch_enrollment ADD INDEX(visit_date);
  SELECT "Successfully created mch enrollment table";
  create table tools_mch_antenatal_visit as
    select
      patient_id,
      uuid,
      visit_id,
    ...
    from etl_mch_antenatal_visit;

  ALTER TABLE tools_mch_antenatal_visit ADD FOREIGN KEY (patient_id) REFERENCES tools_patient_demographics(patient_id);
  ALTER TABLE tools_mch_antenatal_visit ADD INDEX(visit_date);
  SELECT "Successfully created mch antenatal visit table";
  create table tools_mch_delivery as
    select
      patient_id,
      uuid,
      provider,
    ...
    from etl_mchs_delivery;

  ALTER TABLE tools_mch_delivery ADD FOREIGN KEY (patient_id) REFERENCES tools_patient_demographics(patient_id);
  ALTER TABLE tools_mch_delivery ADD INDEX(visit_date);
  SELECT "Successfully created mchs delivery table";
  create table tools_mch_discharge as
    select
      patient_id,
      uuid,
      provider,
    ...
    from etl_mchs_discharge;
  ALTER TABLE tools_mch_discharge ADD FOREIGN KEY (patient_id) REFERENCES tools_patient_demographics(patient_id);
  ALTER TABLE tools_mch_discharge ADD INDEX(visit_date);

  SELECT "Successfully created mch_discharge table";
  create table tools_mch_postnatal_visit as
    select
      patient_id,
      uuid,
      visit_id,
    ...
    from etl_mch_postnatal_visit;

  ALTER TABLE tools_mch_postnatal_visit ADD FOREIGN KEY (patient_id) REFERENCES tools_patient_demographics(patient_id);
  ALTER TABLE tools_mch_postnatal_visit ADD INDEX(visit_date);
SELECT "Successfully created post natal visit table";
  create table tools_hei_enrollment as
    select
      serial_no,
      patient_id,
      uuid,
     ...
     hiv_status_at_exit
    from etl_hei_enrollment;

  ALTER TABLE tools_hei_enrollment ADD FOREIGN KEY (patient_id) REFERENCES tools_patient_demographics(patient_id);
  ALTER TABLE tools_hei_enrollment ADD INDEX(visit_date);
  SELECT "Successfully created hei_enrollment";
  create table tools_hei_follow_up_visit as
    select
      patient_id,
      uuid,
      provider,
      ...
      comments,
      next_appointment_date
    from etl_hei_follow_up_visit;

  ALTER TABLE tools_hei_follow_up_visit ADD FOREIGN KEY (patient_id) REFERENCES tools_patient_demographics(patient_id);

  ALTER TABLE tools_hei_follow_up_visit ADD INDEX(visit_date);
  ALTER TABLE tools_hei_follow_up_visit ADD INDEX(infant_feeding);

  SELECT "Successfully created hei_follow_up_visit";
  create table tools_hei_immunization as
    select
      patient_id,
			visit_date,
			created_by,
			...
			VitaminA_2_to_5_yr,
			fully_immunized
    from etl_hei_immunization;

  ALTER TABLE tools_hei_immunization ADD FOREIGN KEY (patient_id) REFERENCES tools_patient_demographics(patient_id);
  SELECT "Successfully created hei_immunization table";
  create table tools_tb_enrollment as
    select
      patient_id,
      uuid,
      provider,
    ...
    from etl_tb_enrollment;

  ALTER TABLE tools_tb_enrollment ADD FOREIGN KEY (patient_id) REFERENCES tools_patient_demographics(patient_id);

  ALTER TABLE tools_tb_enrollment ADD INDEX(visit_date);
SELECT "Successfully created tb enrollment table";
create table tools_tb_follow_up_visit as
select 
patient_id,
uuid,
provider,
...
next_appointment_date
from etl_tb_follow_up_visit;
 
ALTER TABLE tools_tb_follow_up_visit ADD FOREIGN KEY (patient_id) REFERENCES tools_patient_demographics(patient_id);

ALTER TABLE tools_tb_follow_up_visit ADD INDEX(visit_date);
ALTER TABLE tools_tb_follow_up_visit ADD INDEX(hiv_status);
SELECT "Successfully created tb followup table";
create table tools_tb_screening as
select
patient_id,
uuid,
provider,
...
notes
from etl_tb_screening;

ALTER TABLE tools_tb_screening ADD FOREIGN KEY (patient_id) REFERENCES tools_patient_demographics(patient_id);
ALTER TABLE tools_tb_screening ADD INDEX(visit_date);
SELECT "Successfully created tb screening table";
create table tools_drug_event as
    select
      uuid,
      patient_id,
      date_started,
...
ALTER TABLE tools_drug_event add FOREIGN KEY(patient_id) REFERENCES tools_patient_demographics(patient_id);

SELECT "Successfully created drug event table";
     create table tools_art_preparation as
      select
     uuid,
     patient_id,
     visit_id,
    ...
    from etl_ART_preparation;

    ALTER TABLE tools_art_preparation ADD FOREIGN KEY (patient_id) REFERENCES tools_patient_demographics(patient_id);
    ALTER TABLE tools_art_preparation ADD INDEX(visit_date);
    ALTER TABLE tools_art_preparation ADD INDEX(ready_to_start_art);

SELECT "Successfully created art preparation table";
  create table tools_enhanced_adherence as
    select
      uuid,
      patient_id,
      visit_id,
      ...
      adherence_plan,
      next_appointment_date
    from etl_enhanced_adherence;
  ALTER TABLE tools_enhanced_adherence ADD FOREIGN KEY (patient_id) REFERENCES tools_patient_demographics(patient_id);
  ALTER TABLE tools_enhanced_adherence ADD INDEX(visit_date);

SELECT "Successfully created enhanced adherence table";
  create table tools_triage as
    select
      uuid,
      patient_id,
      visit_id,
      ...
      last_menstrual_period,
      voided
    from etl_patient_triage;

  ALTER TABLE tools_triage ADD FOREIGN KEY (patient_id) REFERENCES tools_patient_demographics(patient_id);
  ALTER TABLE tools_triage ADD INDEX(visit_date);
  SELECT "Successfully created triage table";
  create table tools_patient_contact as
    select
        id,
        uuid,
        date_created,
       ...
       (case consented_contact_listing when 1065 then "Yes" when 1066 then "No" when 1067 then "Unknown" else "" end) as consented_contact_listing,
        voided
    from etl_patient_contact;
  ALTER TABLE tools_patient_contact ADD PRIMARY KEY(id);
  ALTER TABLE tools_patient_contact ADD FOREIGN KEY (patient_related_to) REFERENCES tools_patient_demographics(patient_id);
  ALTER TABLE tools_patient_contact ADD INDEX(date_created);
  SELECT "Successfully created patient_contact table";
  create table tools_client_trace as
    select
      id,
      uuid,
      date_created,
      ...
      appointment_date,
      voided
    from etl_client_trace;
  ALTER TABLE tools_client_trace ADD FOREIGN KEY (client_id) REFERENCES tools_patient_contact(id);
  ALTER TABLE tools_client_trace ADD INDEX(date_created);
  SELECT "Successfully created client_trace table";

SELECT "creating hts_test table";
create table tools_hts_test
  as select t.* from etl_hts_test t
                                              inner join etl_patient_demographics d on d.patient_id = t.patient_id and d.voided=0;
ALTER TABLE tools_hts_test ADD FOREIGN KEY(patient_id) REFERENCES tools_patient_demographics(patient_id);
ALTER TABLE tools_hts_test ADD INDEX(visit_date);
ALTER TABLE tools_hts_test ADD index(population_type);
ALTER TABLE tools_hts_test ADD index(final_test_result);

SELECT "Successfully created hts_test table";

create table tools_hts_referral_and_linkage
  as select l.* from etl_hts_referral_and_linkage l inner join etl_patient_demographics d on d.patient_id = l.patient_id and d.voided=0;
ALTER TABLE tools_hts_referral_and_linkage ADD FOREIGN KEY(patient_id) REFERENCES tools_patient_demographics(patient_id);
ALTER TABLE tools_hts_referral_and_linkage ADD index(visit_date);

SELECT "Successfully created referral_and_linkage table";

create table tools_hts_referral
  as select r.* from etl_hts_referral r inner join etl_patient_demographics d on d.patient_id = r.patient_id and d.voided=0;

create table tools_current_in_care as select * from etl_current_in_care;
ALTER TABLE tools_current_in_care add FOREIGN KEY(patient_id) REFERENCES tools_patient_demographics(patient_id);

create table tools_ipt_followup as select * from etl_ipt_follow_up;
alter table tools_ipt_followup add FOREIGN KEY(patient_id) REFERENCES tools_patient_demographics(patient_id);

CREATE TABLE  tools_default_facility_info as SELECT * from etl_default_facility_info;
CREATE TABLE tools_person_address as SELECT * from etl_person_address;
create table tools_alcohol_drug_abuse_screening as
select
patient_id,
uuid,
provider,
...
date_last_modified,
voided
from etl_alcohol_drug_abuse_screening;

ALTER TABLE tools_alcohol_drug_abuse_screening ADD FOREIGN KEY (patient_id) REFERENCES tools_patient_demographics(patient_id);
ALTER TABLE tools_alcohol_drug_abuse_screening ADD INDEX(visit_date);
SELECT "Successfully created alcohol_drug_abuse_screening table";

create table tools_gender_based_violence as select * from etl_gender_based_violence;
alter table tools_gender_based_violence add FOREIGN KEY(client_id) REFERENCES tools_patient_demographics(patient_id);
ALTER TABLE tools_gender_based_violence ADD INDEX(visit_date);

UPDATE etl_script_status SET stop_time=NOW() where id= script_id;
...
INSERT INTO etl_script_status(script_name, start_time) VALUES('initial_creation_of_tables', NOW());
SET script_id = LAST_INSERT_ID();
...
drop table if exists etl_gender_based_violence;
...
CREATE TABLE etl_patient_program (
  ...
  CREATE TABLE etl_patient_contact (
    ...
    date_last_modified DATETIME,
    voided INT(11),
    CONSTRAINT FOREIGN KEY (patient_related_to) REFERENCES etl_patient_demographics(patient_id),
    CONSTRAINT unique_uuid UNIQUE(uuid),
    INDEX(date_created),
    INDEX(id),
  ...
  CREATE TABLE etl_client_trace (
    ...
    appointment_date       DATETIME,
    voided INT(11),
    CONSTRAINT FOREIGN KEY (client_id) REFERENCES etl_patient_contact(id),
    CONSTRAINT unique_uuid UNIQUE(uuid),
    INDEX(date_created),
    INDEX(id),
    INDEX(id, date_created)
  ...
  SELECT "Successfully created etl_viral_load table";
    create table etl_contact (
      ...
      voided INT(11),
      constraint foreign key(client_id) references etl_patient_demographics(patient_id),
      CONSTRAINT unique_uuid UNIQUE(uuid),
      index(client_id),
...
INSERT INTO etl_script_status(script_name, start_time) VALUES('initial_population_of_tables', NOW());
...
UPDATE etl_script_status SET stop_time=NOW() where id= populate_script_id;
...
insert into etl_alcohol_drug_abuse_screening(
patient_id,
uuid,
provider,
visit_id,
...
BEGIN
    ...
    insert into etl_ART_preparation(
...
insert into etl_ccc_defaulter_tracing(
uuid,
provider,
patient_id,
visit_id,
...
insert into etl_cervical_cancer_screening(
    uuid,
    encounter_id,
    encounter_provider,
    patient_id,
...
update etl_cervical_cancer_screening scr,
     (
     SELECT
            ThisRow.uuid,
            ThisRow.patient_id,
     ...
     FROM
          etl_cervical_cancer_screening    AS ThisRow
            LEFT JOIN
              etl_cervical_cancer_screening    AS PrevRow
              ON  PrevRow.patient_id   = ThisRow.patient_id
                    AND PrevRow.visit_date = (SELECT MAX(s.visit_date)
                                              FROM etl_cervical_cancer_screening s
...
BEGIN
    ...
    insert into etl_client_enrollment (
        uuid,
        client_id,
        visit_id,
        visit_date,
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_populate_etl_client_registration` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`openmrs_user`@`localhost` PROCEDURE `sp_populate_etl_client_registration`()
BEGIN
    SELECT "Processing client registration data ", CONCAT("Time: ", NOW());
    insert into etl_client_registration(
        client_id,
        registration_date,
        given_name,
        middle_name,
    ...
    update etl_client_registration r
    left outer join
    (
    select
           pa.person_id,
    ...
    from person_attribute pa
           inner join
             ...
             where pat.retired=0
                        ...
                        and pat.uuid in (
            'aec1b592-1d8a-11e9-ab14-d663bd873d93',
      ...
      voided
        ...
        ct.voided
			from kenyaemr_hiv_testing_client_trace ct
				inner join etl_patient_contact pc on pc.id=ct.client_id and ct.voided=0
        where pc.voided=0
		;
...
BEGIN
        ...
        INSERT INTO etl_clinical_visit(
            uuid,
            client_id,
            visit_id,
            visit_date,
...
BEGIN
		...
		insert into etl_enhanced_adherence(
			uuid,
			patient_id,
			visit_id,
			visit_date,
...
insert into etl_gender_based_violence(
uuid,
provider,
client_id,
visit_id,
...
BEGIN
		...
		insert into etl_hei_enrollment(
			patient_id,
			uuid,
			provider,
			visit_id,
...
BEGIN
		...
		insert into etl_hei_follow_up_visit(
			patient_id,
			uuid,
			provider,
			visit_id,
...
BEGIN
  SELECT "Processing hei_immunization data ", CONCAT("Time: ", NOW());
    insert into etl_hei_immunization(
    patient_id,
    visit_date,
    created_by,
    date_created,
...
INSERT INTO etl_patient_hiv_followup(
patient_id,
visit_id,
visit_date,
location_id,
...
BEGIN
		...
		INSERT INTO etl_hts_linkage_tracing(
			uuid,
			patient_id,
			visit_date,
			location_id,
...
BEGIN
		...
		insert into etl_ipt_initiation(
			patient_id,
			uuid,
			encounter_provider,
			visit_date ,
...
insert into etl_laboratory_extract(
uuid,
encounter_id,
patient_id,
location_id,
...
BEGIN
		...
		insert into etl_mch_antenatal_visit(
			patient_id,
			uuid,
			visit_id,
			visit_date,
...
BEGIN
		...
		insert into etl_mchs_discharge(
			patient_id,
			uuid,
			provider,
			visit_id,
...
BEGIN
		...
		insert into etl_mch_enrollment(
			patient_id,
			uuid,
			visit_id,
			visit_date,
...
BEGIN
		...
		insert into etl_mch_postnatal_visit(
			patient_id,
			uuid,
			visit_id,
			visit_date,
...
BEGIN
		...
		INSERT INTO etl_otz_enrollment(
			uuid,
			patient_id,
			visit_date,
			location_id,
...
BEGIN
		...
		INSERT INTO etl_patient_contact(
      id,
      uuid,
      date_created,
      date_last_modified,
      ...
      voided
        ...
        pc.voided
			from kenyaemr_hiv_testing_patient_contact pc
				inner join etl_patient_demographics dm on dm.patient_id=pc.patient_related_to and dm.voided=0
        where pc.voided=0
		;
...
BEGIN
		...
		INSERT INTO etl_patient_program(
			uuid,
			patient_id,
			location_id,
			program,
...
BEGIN
		...
		INSERT INTO etl_patient_triage(
			uuid,
			patient_id,
			visit_id,
			visit_date,
...
BEGIN
    ...
    INSERT INTO etl_person_address(
      uuid,
      patient_id,
      county,
      sub_county,
...
insert into etl_pharmacy_extract(
obs_group_id,
patient_id,
uuid,
visit_date,
...
BEGIN
    ...
    insert into etl_prep_behaviour_risk_assessment(
        uuid,
        provider,
        patient_id,
        visit_id,
...
BEGIN
    ...
    insert into etl_prep_discontinuation(
        uuid,
        provider,
        patient_id,
        visit_id,
...
BEGIN
    ...
    insert into etl_prep_enrolment(
        uuid,
        provider,
        patient_id,
        visit_id,
...
BEGIN
    ...
    insert into etl_prep_monthly_refill(
        uuid,
        provider,
        patient_id,
        visit_id,
...
insert into etl_PrEP_verification(
uuid,
provider,
client_id,
visit_id,
...
insert into etl_patient_program_discontinuation(
patient_id,
uuid,
visit_id,
visit_date,
...
from encounter e
	inner join person p on p.person_id=e.patient_id and p.voided=0
	inner join obs o on o.encounter_id=e.encounter_id and o.voided=0 and o.concept_id in (161555,164384,1543,159495,160649,1285,164133)
inner join
(
	select encounter_type_id, uuid, name from encounter_type where
...
insert into etl_tb_follow_up_visit(
patient_id,
uuid,
provider,
visit_id ,
...
insert into etl_treatment_verification(
uuid,
provider,
client_id,
visit_id,
...
INSERT INTO etl_hts_referral_and_linkage (
  patient_id,
  visit_id,
  encounter_id,
  encounter_uuid,
...
BEGIN
    ...
    SELECT max(start_time) into last_update_time from etl_script_status where stop_time is not null or stop_time !="";

    INSERT INTO etl_script_status(script_name, start_time) VALUES('scheduled_updates', NOW());
    ...
    UPDATE etl_script_status SET stop_time=NOW() where  id= update_script_id;
    DELETE FROM etl_script_status where script_name in ("KenyaEMR_Data_Tool", "scheduled_updates") and start_time < DATE_SUB(NOW(), INTERVAL 12 HOUR);
...
CREATE TABLE etl_current_in_care AS
	...
	from etl_patient_hiv_followup fup
		...
		left outer join etl_drug_event de on e.patient_id = de.patient_id and de.program='HIV' and date(date_started) <= date(endDate)
		left outer JOIN
		(select patient_id, coalesce(date(effective_discontinuation_date),visit_date) visit_date,max(date(effective_discontinuation_date)) as effective_disc_date from etl_patient_program_discontinuation
...
ALTER TABLE etl_current_in_care ADD INDEX(enroll_date);
ALTER TABLE etl_current_in_care ADD INDEX(latest_vis_date);
ALTER TABLE etl_current_in_care ADD INDEX(latest_tca);
ALTER TABLE etl_current_in_care ADD INDEX(started_on_drugs);
ALTER TABLE etl_current_in_care ADD INDEX(patient_id);
...
INSERT INTO etl_last_month_newly_enrolled_in_care
...
INSERT INTO etl_last_month_newly_on_art
...
from (
     ...
     from (select e.patient_id,p.dob,p.Gender,min(e.date_started) as date_started,
           ...
           group by e.patient_id) e
            left outer join etl_patient_program_discontinuation d on d.patient_id=e.patient_id
...
TRUNCATE TABLE etl_patients_booked_today;
ALTER TABLE etl_patients_booked_today AUTO_INCREMENT = 1;

INSERT INTO etl_patients_booked_today(patient_id, last_visit_date)
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_update_etl_client_registration` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`openmrs_user`@`localhost` PROCEDURE `sp_update_etl_client_registration`(IN last_update_time DATETIME)
BEGIN
    SELECT "Processing client registration data ", CONCAT("Time: ", NOW());
    insert into etl_client_registration(
        client_id,
...
-- Dump completed on 2021-04-11 19:39:59
